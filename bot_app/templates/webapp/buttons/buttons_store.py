...
helps_btn = ReplyKeyboardMarkup([
    ...
    [KeyboardButton("⬅️ Как мы работаем 🛠"), KeyboardButton("🗣 ЧаВо")]
], resize_keyboard=True)


profile_avia_btn = ReplyKeyboardMarkup([
    ["✈️ Забронировать Билеты", "💎 Спецпредложения"],
    ["🔙 Назад в сервис"],
], resize_keyboard=True)


profile_hotel_btn = ReplyKeyboardMarkup([
    ["🏯 Забронировать Жильё", "💎 Спецпредложения"],
    ["🔙 Назад в сервис"],
], resize_keyboard=True)
